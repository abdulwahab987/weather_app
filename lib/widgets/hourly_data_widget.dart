...
class HourlyDataWidget extends StatelessWidget {
 ...
 HourlyDataWidget({this.weatherDataHourly});
...
class HourlyDetails extends StatelessWidget {
  ...
  String getTime(int timeStam){
    DateTime time =DateTime.fromMillisecondsSinceEpoch(timeStam*500);
    String x= DateFormat.jm().format(time);
    return x;
  }

  HourlyDetails({required this.timeStamp,required this.temp,required this.weatherIcon,required this.index,required this.cardIndex});
